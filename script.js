...
var xhr = new XMLHttpRequest();
xhr.open("GET", "https://eu.api.battle.net/wow/character/"+frm1.realm+ "/"+character name+"?fields=reputation&locale=en_GB&apikey=7djtrck735sj9vj9kmtdkyxdaqvqm9f9", false);
xhr.send();
